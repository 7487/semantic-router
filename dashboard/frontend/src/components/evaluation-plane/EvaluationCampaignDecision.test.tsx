...
describe('EvaluationCampaignDecision model-pool reliability', () => {
  it('keeps release outcomes primary and reproducibility records in one closed disclosure', () => {
    ...
    expect(decisionSurface).toContain('Cost, latency, and capacity')
    ...
    expect(technicalDetails).toContain('Reproducibility, run identities, and verification receipts')
    ...
    expect(technicalDetails).toContain('Controlled value comparison · Candidate run')
