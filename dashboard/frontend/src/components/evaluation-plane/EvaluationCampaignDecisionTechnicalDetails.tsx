...
export default function EvaluationCampaignDecisionTechnicalDetails({
  ...
  return (
    <details className={styles.technicalDisclosure} data-evaluation-technical-details="true">
      <summary>
        <span className={styles.technicalSummaryCopy}>
          <strong>Technical details</strong>
          <small>Reproducibility, run identities, and verification receipts</small>
        </span>
      ...
      <div className={styles.technicalBody}>
        ...
        <RunRecords anchors={decision.evidence} runNames={runNames} />
