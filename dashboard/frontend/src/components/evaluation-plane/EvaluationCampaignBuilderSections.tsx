  ...
  return (
    <>
      ...
      <div className={styles.profileGrid}>
        ...
        <dl className={styles.profileSummary} aria-label="Release readiness summary">
          <div>
...
function EvaluationCampaignRoleMatrix({ builder, view }: SectionProps) {
  return (
    <div className={styles.roleMatrixFrame} role="region" aria-label="Release decision inputs">
          ...
          {builder.model.slots.map((slot) => {
            ...
            return (
              <tr key={slot.gate_id} data-gate={slot.gate_id} data-selected={selected}>
                <th scope="row">
                  <strong>{evaluationGateCapabilityLabel(slot.gate_id)}</strong>
