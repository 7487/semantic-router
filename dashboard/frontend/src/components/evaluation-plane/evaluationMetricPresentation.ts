...
const METRIC_LABELS: Readonly<Record<string, string>> = {
  ...
  'agentic.recovery_pass_rate': 'Recovery success rate',
  'agentic.recovery_pass_rate_lower_95': 'Recovery success lower confidence estimate',
  ...
  'capacity.error_rate': 'Request error rate',
  'capacity.error_rate_upper_bound': 'Error-rate upper confidence estimate',
  ...
  'capacity.success_rate': 'Request success rate',
...
const CAPACITY_LEVEL_LABELS: Readonly<Record<string, string>> = {
  ...
  error_rate_upper_bound: 'Error-rate upper confidence estimate',
