...
describe('EvaluationGateList', () => {
  it('keeps implementation identities behind technical details', () => {
    ...
    const gate: EvaluationGate = {
      id: 'G3',
      name: 'G3 · controlled-pair-contract-v2',
    ...
    expect(markup).toContain('<strong>Controlled value comparison</strong>')
    ...
    expect(markup.slice(0, technicalDetailsStart)).not.toContain(gate.name)
