...
// IsRoutingRecipeMetricID validates only the encoded grammar. Publication must
// also use IsPlannedRoutingRecipeMetricID against the frozen plan's exact set.
