...
func (s *Store) createControlledPairBundlesAs(
	...
	intentDurable = true
	if err := s.controlledPairFail("publication_intent"); err != nil {
		return controlledPairManifest{}, err
	}
	if err := publishStagedInitialBundle(items[0], s.pairPersistence.Rename); err != nil {
		return controlledPairManifest{}, err
	}
	if err := s.controlledPairFail("baseline_published"); err != nil {
		return controlledPairManifest{}, err
	}
	if err := publishStagedInitialBundle(items[1], s.pairPersistence.Rename); err != nil {
		return controlledPairManifest{}, err
	}
	if err := s.controlledPairFail("candidate_published"); err != nil {
		return controlledPairManifest{}, err
	}
	if err := syncEvaluationDirectory(s.runsRoot, "controlled pair members"); err != nil {
		return controlledPairManifest{}, err
	}
	...
	if err := s.controlledPairFail("publication_committed"); err != nil {
		return controlledPairManifest{}, err
	}
