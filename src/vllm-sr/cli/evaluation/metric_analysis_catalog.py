...
The packaged JSON resource is canonical. Go and TypeScript ship byte-identical
mirrors so every runtime can validate reports without a Python dependency.
"""
...
from cli.evaluation.metric_analysis_catalog_validation import (
    EXPECTED_DYNAMIC_FAMILY_COUNT as _EXPECTED_DYNAMIC_FAMILY_COUNT,
)
from cli.evaluation.metric_analysis_catalog_validation import (
    EXPECTED_STATIC_METRIC_COUNT as _EXPECTED_STATIC_METRIC_COUNT,
)
from cli.evaluation.metric_analysis_catalog_validation import (
...
EXPECTED_DYNAMIC_FAMILY_COUNT = _EXPECTED_DYNAMIC_FAMILY_COUNT
EXPECTED_STATIC_METRIC_COUNT = _EXPECTED_STATIC_METRIC_COUNT
